...
> Whisper to interact or else I wont see your message. Off tab 99% of the time.
   ...
   [ASK ME STUFF!!!!!](https://retrospring.net/@xvnoctis) ${\color{blue}─}$ [SENTRY](https://sntry.cc/@willgraham) ${\color{blue}─}$ [LAST.FM](https://www.last.fm/user/cybpnk) ${\color{blue}─}$ [SPOTIFY](https://open.spotify.com/user/tn772at7vmvojbim4ltard2yy?si=ea17f7a69ce94db5) ${\color{blue}─}$ [SENTRY HOARD](https://sntry.cc/@myurls)
